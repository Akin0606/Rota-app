    ...
    <div className="px-4 pb-[calc(150px+env(safe-area-inset-bottom))] pt-2 md:pb-28">
      ...
      <div className="grid grid-cols-2 gap-2.5">
        ...
        <div className="col-span-2 flex items-center justify-between rounded-cp-panel border-[0.5px] border-hairline bg-surface-card px-3.5 py-3">
          ...
          >
            {/* VIS-7: hairline ring keeps the white knob legible on the neutral
                (near-white) accent track when ON in dark mode. A ring, not a
                drop shadow (flat brand). */}
            <span
              className={`absolute top-[3px] h-5 w-5 rounded-full bg-white ring-1 ring-black/10 transition-transform ${
